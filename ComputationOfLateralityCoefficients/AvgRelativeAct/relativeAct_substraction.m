...
load(strcat(SubjectPath, filesep,  'RelativeActSubstraction', filesep, 'LI_MaxBroca_', num2str(TimeInt(1)), '-',num2str(TimeInt(2)), 's.mat'))
LI_All(1,1)=LI.LI_Max;
clear LI.LI_Max
LI_All(1,2)=LI.LI_Max_squared;
clear LI.LI_Max_squared

load(strcat(SubjectPath, filesep,  'RelativeActSubstraction', filesep, 'LI_MaxWernicke_', num2str(TimeInt(1)), '-',num2str(TimeInt(2)), 's.mat'))
