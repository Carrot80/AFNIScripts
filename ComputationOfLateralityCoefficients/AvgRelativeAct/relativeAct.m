...
function forAll(Folder, group)
    ...
    Path_LI_All=strcat('/home/kh/ShareWindows/Results/RelativeAct/LI_All_RelAct_', num2str(TimeInt(1)), '_', num2str(TimeInt(2)), 's_', group, '.mat')
...
function kh_SAM_RelAct (SubjectPath, SubjectName, TimeInt, group)
    ...
    avgBaseline=avgBL.avg(:,150:458); % in etwa
